...
* **Primary Language Model (LLM):** Groq / Meta Llama 3.3 70B Versatile
* **Fallback Language Model (LLM):** OpenAI / GPT-4.1-mini
...
4. Configure your API Credentials for Groq, OpenAI, Pinecone, and Cohere.
